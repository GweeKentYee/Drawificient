...
<header class="sticky-top">
         <nav class="navbar navbar-expand-lg navbar-light">
          ...
          <div class="dropdown-menu" aria-labelledby="datatable">
                ...
                <a class="dropdown-item active" href="comment_table.php">COMMENT</a>
    ...
    <div class="container">
            ...
            <div class="panel panel-default">
                <h2 class="panel-heading">COMMENT TABLE</h2>
    ...
    <footer class="footer mt_auto py-3">
    ...
    $('#sample_data').on('draw.dt', function(){
        $('#sample_data').Tabledit({
            ...
            columns:{
                ...
                editable:[[5, 'status', '{"Show":"Show","Restrict":"Restrict"}']]
            },
            deleteButton:false,
            restoreButton:false,
