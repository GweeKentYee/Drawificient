               ...
               <ul class="navbar-nav">
                  ...
                  <li class="nav-item dropdown">
                     ...
                     <div class="dropdown-menu" aria-labelledby="datatable">
                        ...
                        <a class="dropdown-item active" href="report_forum_table.php">REPORT FORUM</a>
