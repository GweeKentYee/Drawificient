...
$column = array("comment_id", "caption", "time", "forum_id", "user_id", "status");
...
{
    $query .= '
    WHERE comment_id LIKE "%'.$_POST["search"]["value"].'%" OR caption LIKE "%'.$_POST["search"]["value"].'%" OR time LIKE "%'.$_POST["search"]["value"].'%" OR status LIKE "%'.$_POST["search"]["value"].'%" OR forum_id LIKE "%'.$_POST["search"]["value"].'%" OR user_id LIKE "%'.$_POST["search"]["value"].'%"';
}
