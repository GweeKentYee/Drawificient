               ...
               <ul class="navbar-nav">
                  ...
                  <li class="nav-item dropdown">
                     ...
                     <div class="dropdown-menu" aria-labelledby="datatable">
                        ...
                        <a class="dropdown-item active" href="forum_table.php">FORUM</a>
      ...
      <main>
         <div class="container">
            ...
            <div class="panel panel-default">
               <h2 class="panel-heading">FORUM TABLE</h2>
       ...
       $('#sample_data').on('draw.dt', function(){
           $('#sample_data').Tabledit({
               ...
               columns:{
                   ...
                   identifier : [0, 'forum_id'],
                   editable:[[6, 'status', '{"Show":"Show", "Restrict":"Restrict"}']]
               },
               deleteButton:false,
               restoreButton:false,
