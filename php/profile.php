...
<html lang="en">
   ...
   <header class="sticky-top">
               ...
               <ul class="navbar-nav mr-auto w-100 justify-content-end">
                  ...
                  <li class="nav-item dropdown">
                     ...
                     <div class="dropdown-menu dropdown-menu-lg-right" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item active" href="profile.php?id=<?php echo $_SESSION['id'] ?>"><i class="fas fa-user"></i> View Profile</a>
      ...
      <div>
         <br>
         <a name='profile_back' id="profile_back" onclick="goBack()" ><button class = "btn btn-outline-dark">Back</button></a>
         <script>
            function goBack(){
               window.history.back();
            }
      ...
      <?php 
         ...
         ?>
      <div id = "profile_area" class="container col-xl-11 col-lg-11 col-md-11 col-sm-11 col-11 border border-dark rounded">
      <br>
      <!--to show image-->
      <div class="container row">
         <?php
            ...
            {
                echo '<img id= "profile_picture" class = "rounded-circle" alt="Profile Pic " src="data:image/jpeg;base64, '.base64_encode($profile).'"/>';
            }
            //showing image ends here
            ?>
         <h2 id = "profile_username"><?php echo $username ?></h2>
         
      </div>
      <br><!--container for pic and username-->
      <div class="row row-cols-1">
         <div class = "col-xl-9 col-lg-9 col-md-9 col-sm-9 order-xl-1 order-lg-1 order-md-1 order-sm-2 order-2">
            <!--intended for mini posts-->
            <h2 class = "profile_area_title">Posts made by this user</h2>
            <hr class = "my-4">
            <div class="profile_forum forum_area border border-dark">
               <?php
                  ...
                  $sqlForum = "SELECT * FROM forum join user on forum.user_id = user.user_id WHERE user.user_id='$userid' ORDER BY time DESC";
               ...
               <div class="forumstyle">
                  ...
                  <div class="post_header">
                     ...
                     <span class="username_forum"><?php echo $user_forum; ?></span></a><br>
                           ...
                           <div class="modal-content">
                              ...
                              <form action="report.php" method="post">
                                 <div class="modal-body">
                                    ...
                                    <input type="hidden" name="location" value="profile.php">
                                    <input type="hidden" name="redirect_id" value="<?php echo $userid;?>">
                     ...
                     <div class="commentstyle">
                        <form method="POST" action="insertcomment.php">
                           ...
                           <div class="comment_content">
                              ...
                              <input type="hidden" name="forum_id" value="<?php echo $forum_id ;?>">
                              <input type="hidden" name="user_id" value="<?php echo $_SESSION['id'] ;?>">
                              <textarea id="comment" name="comment" class="comment_box border-primary" cols="60" row="1" placeholder="Enter your comment" required></textarea>
                           </div>
                        </form>
                        <br>
                        <br>
            ...
            <!--ending for intended for mini posts-->
            <div class = "col-xl-3 col-lg-3 col-md-3 col-sm-3 order-xl-2 order-lg-2 order-md-2 order-sm-1 order-1">
               <!--might change-->
               <h2 class="profile_area_title">User Details</h2>
               <hr class = "my-4">
               <div class="card border-dark mb-3">
                  <!--Profile details(fname,lname,email)-->
                  <div class="card-body text-dark">
                     <?php 
                        ...
                        { ?>
                     <a class href = 'Profile_edit.php'>
                        <h5 name='editprofile' id="editprofile" class="btn btn-outline-dark">Edit Profile</h5>
                     </a>
                     <?php
                        }
                        else
