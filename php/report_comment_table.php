               ...
               <ul class="navbar-nav">
                  ...
                  <li class="nav-item dropdown">
                     ...
                     <div class="dropdown-menu" aria-labelledby="datatable">
                        ...
                        <a class="dropdown-item active" href="report_comment_table.php">REPORT COMMENT</a>
                     </div>
                  </li>
               </ul>
       ...
       $('#sample_data').on('draw.dt', function(){
           $('#sample_data').Tabledit({
               ...
               columns:{
                   ...
                   identifier : [0, 'rc_id'],
                   editable:[[5, 'status', '{"Under Investigation":"Under Investigation","Complete":"Complete"}']]
               },
               deleteButton:false,
               restoreButton:false,
