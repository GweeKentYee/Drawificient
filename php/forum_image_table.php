               ...
               <ul class="navbar-nav">
                  ...
                  <li class="nav-item dropdown">
                     ...
                     <div class="dropdown-menu" aria-labelledby="datatable">
                        ...
                        <a class="dropdown-item active" href="forum_image_table.php">FORUM IMAGE</a>
      ...
      <main>
         <div class="container">
            ...
            <div class="panel panel-default">
               <h2 class="panel-heading">FORUM IMAGE TABLE</h2>
...
<script type="text/javascript" language="javascript">
   $(document).ready(function(){
       var dataTable = $('#sample_data').DataTable({
           ...
           "order" : [],
           "ajax" : {
               url:"fetch_forum_image.php",
               type:"POST"
           }
       });
       $('#sample_data').on('draw.dt', function(){
           $('#sample_data').Tabledit({
               url: 'forum_image_action.php',
               dataType: 'json',
               buttons: {
   				edit: {
               ...
               columns:{
                   ...
                   identifier : [0, 'image_id'],
                   editable:[[4, 'status', '{"Show":"Show","Restrict":"Restrict"}']]
               },
               deleteButton:false,
               restoreButton:false,
